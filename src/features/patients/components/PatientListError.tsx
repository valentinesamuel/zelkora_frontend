...
/**
 * Failure surface for the list load. Deliberately inline (not a toast) so it
 * cannot be missed, and deliberately generic — the raw `ApiError` message is
 * never shown to staff.
 */
export function PatientListError({ onRetry }: PatientListErrorProps) {
  return (
    <div
      role="alert"
